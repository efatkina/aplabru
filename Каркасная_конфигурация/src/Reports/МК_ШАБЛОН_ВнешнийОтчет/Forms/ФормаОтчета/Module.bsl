...
#Область ДополнительныйОтчетВызовКлиентскогоМетода
...
#Область ОтчетВызовКлиентскогоМетода
...
Процедура ДобавитьИнформациюОРазработчике()
	...
	ПараметрыИнформацииОРазработчике.Вставить("ИмяОсновногоРеквизитаФормы", "Отчет"); // Строка. Имя основного реквизита формы (Объект, Отчет и пр.)
